package MalariaGEN::AGV::Commands::Run;
...
sub pipeline {
  ...
  my $manifest_object = MalariaGEN::AGV::Manifest::Pipeline->new(file => $manifest_file)
  ...
  my $pipeline_class = MalariaGEN::AGV::Pipeline->class_by_name($type)
