package MalariaGEN::AGV::Engines::Sanger;
...
use MalariaGEN::AGV::Engines::Scratch::Array;
...
has 'scratch' => (is => 'ro', isa => 'MalariaGEN::AGV::Engines::ScratchArray', 
    default => sub { MalariaGEN::AGV::Engines::Sanger::Scratch::Array->new() });
