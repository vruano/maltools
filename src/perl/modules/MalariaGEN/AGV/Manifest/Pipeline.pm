package MalariaGEN::AGV::Manifest::Pipeline;

use Moose;

require MalariaGEN::AGV::Config;
require MalariaGEN::AGV::Manifest::Config;
require MalariaGEN::AGV::Manifest::Pipeline::Sample;
require MalariaGEN::AGV::DataFreeze;

extends 'MalariaGEN::AGV::Manifest';

has '_config' => (is => 'ro' , isa => 'MalariaGEN::AGV::Manifest::Config', default => sub { MalariaGEN::AGV::Config->new() });
...
sub get_reference {
  ...
  return MalariaGEN::AGV::Reference->new(sequence_file => $sequence_file);
}
...
sub get_sample {
  ...
  my @result = map { MalariaGEN::AGV::Manifest::Pipeline::Sample->new(manifest => $self, %{$samples->{$_}}) } @_;
  if ($#_ == 0) {
