...
public enum FragmentFilter {
	...
	GENOMIC_MASK, INVERSION, TRANSLOCATION, FIRST_FACE_AWAY, LAST_FACE_AWAY, BOTH_FACE_AWAY, UNMAPPED, BOTH_UNMAPPED, FIRST_UNMAPPED, LAST_UNMAPPED,
	BOTH_LOW_MQ, FIRST_LOW_MQ, LAST_LOW_MQ, LOW_MQ, INSERTION, DELETION;
	...
	static {
		...
		IMPLIES_MASK[BOTH_FACE_AWAY.ordinal()] |=  impliesMask(BOTH_FACE_AWAY,INVERSION,FIRST_FACE_AWAY,LAST_FACE_AWAY);
		IMPLIES_MASK[FIRST_FACE_AWAY.ordinal()] |= impliesMask(FIRST_FACE_AWAY,INVERSION);
		IMPLIES_MASK[LAST_FACE_AWAY.ordinal()] |= impliesMask(LAST_FACE_AWAY,INVERSION);
