...
public class BernoulliGenotypingModelTest extends WalkerTest {
	...
	public void xxxtestX05() {
		...
		GATKSAMRecord sr = new GATKSAMRecord(sfh);
		sr.setAlignmentStart(1);
		List<PileupElement> pel = Arrays.asList(new PileupElement[] {
				new PileupElement(sr, 1, false, false, false, false, false,
						false),
				new PileupElement(sr, 2, false, false, false, false, false,
						false),
				new PileupElement(sr, 3, false, false, false, false, false,
						false),
				new PileupElement(sr, 4, false, false, false, false, false,
						false) });
	...
	public void test7G8xGb4() throws IOException {
		...
		String[] progenyNames = { "PG0077-CW", "PG0078-CW", "PG0079-CW",
				"PG0080-C", "PG0081-CW", "PG0082-C", "PG0085-C", "PG0086-CW",
				"PG0087-C", "PG0088-C", "PG0090-CW", "PG0091-C", "PG0092-C",
				"PG0093-C", "PG0095-CW", "PG0096-C", "PG0097-C", "PG0098-C",
				"PG0099-C", "PG0100-CW", "PG0101-C", "PG0102-CW", "PG0103-CW",
				"PG0104-CW", "PG0105-CW", "PG0106-C", "PG0107-C", "PG0109-C",
				"PG0110-CW", "PG0111-CW", "PG0112-CW", "PG0113-CW" };
		String[] progenyNames2 = { "PG0077-CW", "PG0100-C", "PG0101-C",
				"PG0092-C", "PG0112-C", "PG0113-C", "PG0110-C", "PG0111-C",
				"PG0085-C", "PG0095-C", "PG0103-C", "PG0094-C", "PG0087-C",
				"PG0104-C", "PG0107-C", "PG0096-C", "PG0098-C", "PG0106-C",
				"PG0109-C", "PG0088-C", "PG0086-C", "PG0099-C", "PG0093-C",
				"PG0091-C", "PG0105-C", "PG0090-C", "PG0097-C", "PG0108-C",
				"PG0102-C" };
