...
//		refFasta,testBam,outDir,complexity),null ); 
		WalkerTest.executeTest("MappabilityAnalisys", String.format("-T CoverageBias -R %s -I %s  -I %s -I %s -o %s -vo %s -mdp 5 -mmq0 0.0 -fsmmq 0 -groupBy RG -uqn:uniqueness,UQN %s -complexity %s",
				refFasta,testBam,testBam2,testBam3,outDir,new File(outDir,"site-by-site.vcf"),uniqueness,complexity), null);
