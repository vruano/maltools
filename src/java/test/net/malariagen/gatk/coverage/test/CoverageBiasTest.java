...
//		refFasta,testBam,outDir,complexity),null ); 
		WalkerTest.executeTest("MappabilityAnalisys", String.format("-T CoverageBias -R %s -I %s -L MAL1:1-600000  -I %s -I %s -o %s -vo %s -mdp 5 -mmq0 0.0 -fs /home/valentin/Science/CoveragePf/FragmentLengths/gatk-out -fsmmq 0 -groupBy RG -uqn:uniqueness,UQN %s",
